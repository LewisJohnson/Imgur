...
namespace ImgurLibrary.Api_Endpoints.Account
{
    public static class Upload
    {
        public static string UploadImage(string accessToken, string image, string title = "", string desc = "", string type = "base64", string format = "xml")
        {
            var imageBase64 = "";
            if (type == "base64")
            {
