...
namespace ImgurLibrary
{
    ...
    {
        public static Dictionary<string, string> AnonImage(string response)
        {
        ...
        public static void UserImage(string response)
        {
            var responseReader = XmlReader.Create(response);
            var data = XElement.Load(responseReader);
